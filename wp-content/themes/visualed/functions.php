...
/* Adding image Size*/
add_image_size( 'home_banner_img', 1920, 846, true );
add_image_size( 'who_img', 848, 560, true );
add_image_size( 'island_img', 1167, 744, true );
add_image_size( 'how_we_img', 1920, 846, true );
add_image_size( 'project_banner', 1920, 843, true );
add_image_size( 'contact_img', 1920, 842, true );
add_image_size( 'about_banner_img', 1920, 846, true );
add_image_size( 'process_img', 1920, 846, true );
add_image_size( 'process_img', 1920, 843, true );
...
function custom_post_process() {
   $args = array(
      'label' => 'our process',
        ...
        'hierarchical' => false,
        'rewrite' => array('slug' => 'our_process'),
        'query_var' => true,
        'supports' => array(
            'title',
            'editor',
...
add_action( 'init', 'custom_post_process' );
/*******End of Custom post process *******/

/*******Start of Custom post work *******/
...
/*******End of Custom post work *******/

/*******Start of Custom post current opening *******/
function custom_post_current_opening() {
   $args = array(
...
add_action( 'init', 'custom_post_current_opening' );
/*******End of Custom post current opening *******/
...
'singular_name' => __('Portfolio category', 'Portfolio category' ),
'search_items' => __( 'Search Portfolio category' ),
'all_items' => __( 'Portfolio category category' ),
